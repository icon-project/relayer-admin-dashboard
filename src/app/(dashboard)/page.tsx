...
export default async function Page() {
    ...
    let balance = await socketManager.getChainBalance(
        chains.map((chain) => ({ chain: chain.nid, address: chain.address }))
    )
        ...
        <Suspense fallback={<Loading />}>
            <div className="row">
                {chains.map((chain, index) => (
                    <div
                        className="col-sm-6 col-lg-3 justify-content-center"
                        key={chain.nid}
                    >
                        <Card
            ...
            <Card className="mb-4">
                <CardBody>
                    <div className="d-flex justify-content-between">
                        <div>
                            <h4 className="mb-0">
                                {dict.dashboard.utilization.title}
                            </h4>
                            <div className="small text-black-50 dark:text-gray-500">
                                {dict.dashboard.utilization.uptime}:{' '}
                                {metrics?.uptime}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row row-cols-10 row-cols-md-8 text-center">
                        <div className="col mb-sm-2 mb-0">
                            <div className="text-black-50 dark:text-gray-500">
                                {dict.dashboard.utilization.cpu}
                            </div>
                        ...
                        <div className="col mb-sm-2 mb-0">
                            <div className="text-black-50 dark:text-gray-500">
                                {dict.dashboard.utilization.memory}
                            </div>
                            <div className="fw-semibold">
                                {metrics?.memory.usedMemoryPercentage}%
                            </div>
                            <ProgressBar
                                className="progress-thin mt-2"
                                variant="info"
                        ...
                        <div className="col mb-sm-2 mb-0">
                            <div className="text-black-50 dark:text-gray-500">
                                {dict.dashboard.utilization.network}
                            </div>
